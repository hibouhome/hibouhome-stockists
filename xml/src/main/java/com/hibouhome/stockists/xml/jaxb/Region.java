 ...
 *       &lt;sequence>
 *         &lt;element name="stockist" type="{}stockist" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlType(name = "region", propOrder = { "stockists" })
public class Region implements Sortable {

	@XmlElement(name = "stockist", required = true)
	...
	public int hashCode() {
		...
		result = prime * result + ((stockists == null) ? 0 : stockists.hashCode());
		return result;
	}
